...
const articleDetailPage = lazyPage(
  () => import("@/pages/user/ArticleDetailPage"),
);
...
// Social OAuth
const socialCallbackPage = lazyPage(
  () => import("@/pages/auth/SocialCallbackPage"),
);
const socialConsentPage = lazyPage(
  () => import("@/pages/auth/SocialConsentPage"),
);
// Error + Legal
...
export const router = createBrowserRouter([
  ...
  // ── 보호 (ProtectedRoute) ──
  {
    ...
    children: [
      ...
      {
        element: <AuthShell />,
        children: [{ path: "/re-consent", element: reConsentPage }],
      },
