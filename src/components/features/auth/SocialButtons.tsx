...
function KakaoIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path d="M12 4C7 4 3 7.1 3 10.9c0 2.4 1.7 4.5 4.2 5.7-.2.6-.7 2.3-.8 2.7 0 .2.1.4.3.2.3-.2 2.6-1.8 3.5-2.4.6.1 1.2.1 1.8.1 5 0 9-3.1 9-6.9S17 4 12 4z" fill="#3C1E1E" />
    </svg>
  );
}
...
function GoogleIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden="true">
      <path fill="#4285F4" d="M21.6 12.2c0-.6-.1-1.3-.2-1.9H12v3.6h5.4c-.2 1.2-.9 2.3-2 3v2.5h3.2c1.9-1.7 3-4.3 3-7.2z" />
      <path fill="#34A853" d="M12 22c2.7 0 5-.9 6.6-2.5l-3.2-2.5c-.9.6-2 .9-3.4.9-2.6 0-4.8-1.7-5.6-4.1H3.1v2.6C4.7 19.8 8.1 22 12 22z" />
      <path fill="#FBBC05" d="M6.4 13.8c-.2-.6-.3-1.2-.3-1.8s.1-1.2.3-1.8V7.6H3.1A10 10 0 002 12c0 1.6.4 3.1 1.1 4.4l3.3-2.6z" />
      <path fill="#EA4335" d="M12 5.9c1.5 0 2.8.5 3.8 1.5l2.8-2.8C16.9 2.9 14.7 2 12 2 8.1 2 4.7 4.2 3.1 7.6l3.3 2.6C7.2 7.6 9.4 5.9 12 5.9z" />
    </svg>
  );
}
