  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {emailError && (
          <p id="login-email-error" className="text-[11.5px] text-danger mt-1">
            {emailError}
          </p>
        )}
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-1.5">
          <label
            ...
            className="text-[12.5px] font-semibold text-ink-700"
          >
            비밀번호
          </label>
          <Link
            to="/forgot-password"
            className="text-[12px] font-medium text-brand hover:text-brand-700 transition-colors"
          >
            비밀번호 찾기
          </Link>
        </div>
        ...
        {passwordError && (
          <p
            ...
            className="text-[11.5px] text-danger mt-1"
          >
            {passwordError}
          </p>
        )}
