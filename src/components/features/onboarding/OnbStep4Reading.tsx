...
export default function OnbStep4Reading({
  depth,
  consumeMode,
  dispatch,
}: OnbStep4ReadingProps) {
  return (
            ...
            return (
              ...
              >
                <div className="flex-1">
                  <div
                    className={`text-[14px] font-bold ${isOn ? "text-brand" : "text-ink"}`}
                  >
                    {o.label}
                  </div>
          ...
          {ONB_MODES.map((m) => {
            ...
            return (
              <button
                ...
                aria-pressed={isOn}
                onClick={() =>
                  dispatch({ type: "SET_CONSUME_MODE", value: m.value })
                }
