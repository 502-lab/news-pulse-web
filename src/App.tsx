  ...
  return (
    <div className="p-8 bg-canvas min-h-screen space-y-6">
      <Card>
        ...
        <div className="flex flex-wrap gap-3">
          {[
            ...
            <div
              key={n}
              className="flex flex-col items-center gap-1 text-[10px] text-ink-400"
            >
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <Card
          hover
          className="h-24 flex items-center justify-center text-ink-400 text-sm"
        >
