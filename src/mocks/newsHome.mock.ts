...
export const NEWS_HOME: NewsItem[] = [
  {
    ...
    time: '3분 전',
    reads: 4821,
    summary: '한국은행 금융통화위원회가 기준금리를 연 3.25%로 인하했다. 내수 침체와 수출 둔화에 선제 대응하기 위한 결정이라고 밝혔다.',
    isBreaking: true,
  },
  {
    id: 'n002',
    ...
    time: '18분 전',
    reads: 3102,
    summary: '삼성전자가 3세대 GAA 아키텍처 기반 3나노 공정 양산을 공식 시작했다. 전력 효율 30% 향상, 성능 15% 개선이 목표다.',
  },
  {
    id: 'n003',
    ...
    time: '35분 전',
    reads: 2754,
    summary: '여야가 추가경정예산안 규모를 둘러싸고 합의점을 찾지 못하고 있다. 여당은 10조 원, 야당은 18조 원을 주장하며 맞서고 있다.',
  },
  {
    id: 'n004',
    ...
    time: '52분 전',
    reads: 1987,
    summary: '국내 AI 반도체 스타트업 퓨리오사AI가 시리즈C 라운드에서 약 3000억 원 규모의 투자 유치에 성공했다. 글로벌 반도체 시장 공략을 가속화한다.',
  },
  {
    id: 'n005',
    ...
    time: '1시간 전',
    reads: 1543,
    summary: '이마트·롯데마트·홈플러스가 연내 새벽 배송 서비스를 출시한다. 쿠팡·컬리가 주도하던 시장에 오프라인 유통 공룡들이 뛰어드는 양상이다.',
  },
  {
    id: 'n006',
    ...
    time: '1시간 전',
    reads: 1201,
    summary: '과기정통부가 2030년까지 AI 분야 전문 인재 30만 명을 양성하겠다는 국가 AI 인재 육성 로드맵을 발표했다.',
  },
  {
    id: 'n007',
    ...
    time: '2시간 전',
    reads: 5632,
    summary: '오픈AI가 GPT-5를 공개했다. 다중 모달 추론 능력과 코드 생성 정확도가 이전 세대 대비 크게 향상됐다는 것이 핵심이다.',
  },
  {
    id: 'n008',
    ...
    time: '2시간 전',
    reads: 987,
    summary: '서울시가 한강변 일대에 최고 70층 규모의 복합개발 사업을 확정 발표했다. 주거·업무·상업시설이 복합 구성된다.',
  },
  {
    id: 'n009',
    ...
    time: '3시간 전',
    reads: 3211,
    summary: '제78회 칸 국제영화제가 박찬욱 감독을 경쟁 부문 심사위원장으로 공식 위촉했다. 아시아 감독의 칸 심사위원장 선임은 이례적이다.',
  },
  {
    id: 'n010',
    ...
    time: '3시간 전',
    reads: 756,
    summary: '크라우드스트라이크가 서울에 공식 한국 지사를 설립했다. 국내 기업의 사이버보안 수요 증가에 대응한 현지화 전략의 일환이다.',
  },
  {
    id: 'n011',
    ...
    time: '4시간 전',
    reads: 2108,
    summary: '여야가 다음 총선 선거구 획정안을 두고 6차 협상에서도 최종 합의에 실패했다. 인구 변화 반영 기준을 놓고 이견이 좁혀지지 않고 있다.',
  },
  {
    id: 'n012',
    ...
    time: '5시간 전',
    reads: 4103,
    summary: '넷플릭스 한국 오리지널 드라마가 공개 첫 주 만에 비영어권 TV 시리즈 부문 글로벌 동시 1위를 달성했다.',
  },
  {
    id: 'n013',
    ...
    time: '5시간 전',
    reads: 1876,
    summary: '현대차그룹이 미국 조지아주에 건설한 전기차 전용 공장 메타플랜트 아메리카(HMGMA) 양산을 시작했다.',
  },
];
