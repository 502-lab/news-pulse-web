      ...
      <div className="w-full max-w-sm text-center">
        ...
        <div className="flex items-center justify-center gap-2 mb-10">
          <svg width="28" height="28" viewBox="0 0 32 32" fill="none" aria-hidden="true">
            ...
            <path d="M8 10h10M8 16h6M8 22h8" stroke="white" strokeWidth="2.5" strokeLinecap="round" />
            <circle cx="22" cy="20" r="5" fill="white" fillOpacity="0.25" stroke="white" strokeWidth="2" />
            <path d="M25.5 23.5L28 26" stroke="white" strokeWidth="2" strokeLinecap="round" />
          </svg>
          <span className="text-[18px] font-extrabold text-ink tracking-tight">Newsift</span>
        </div>

        {/* 404 */}
        <p className="text-[88px] font-extrabold text-brand leading-none tabular-nums">404</p>
