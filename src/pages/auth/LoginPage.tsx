  ...
  return (
    <div>
      {returnTo && !message && (
        <div
          role="status"
          className="flex items-start gap-2.5 text-[13px] text-ink-600 bg-brand-50 border border-brand/20 rounded-btn px-3.5 py-3 mb-5"
        >
          <svg
            width="15"
            height="15"
      ...
      {message && (
        <p
          role="status"
          className="text-sm text-ok bg-ok/5 rounded-input px-3 py-2 mb-5"
        >
          {message}
        </p>
      )}
      ...
      <div className="flex items-center gap-3 my-6">
        ...
        <span className="text-[11.5px] text-ink-400 font-medium shrink-0">
          또는 간편 로그인
        </span>
        <div className="flex-1 h-px bg-ink-200" />
      </div>
